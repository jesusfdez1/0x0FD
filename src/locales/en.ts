export const en = {
  ...
  companies: {
    ...
    detail: {
      ...
      overview: {
        faviconAlt: '{name} icon',
        rank: 'Rank',
        rankHint: 'Market-cap ranking (model).',
        marketCap: 'Market cap',
        marketCapHint: 'Synthetic estimate for fast comparison.',
        country: 'Country',
        countryHint: 'Inferred from venue ({market}).',
        ...
        about: 'About',
        aboutFallback: '{name} is a listed company on {market}. This sheet summarizes price signals, scale, and ratios to speed up context before jumping to external research.',
      },
      facts: {
        kicker: 'Fundamentals',
        title: '{ticker} snapshot',
        subtitle: 'Compact indicators (model) for quick reading.',
        tabs: {
          marketCap: 'Market cap',
          revenue: 'Revenue',
          earnings: 'Earnings',
        ...
        marketCapSectionTitle: 'Market capitalization of {name} ({ticker})',
        marketCapSectionCopy: 'Market capitalization (market cap) is the total market value of outstanding shares. It is commonly used to compare company size.',
        marketCapValueLabel: 'Market cap',
        marketCapValueHint: 'Approximate value for this dashboard (not official).',
        revenue: 'Revenue',
        earnings: 'Earnings',
        peRatio: 'P/E',
        psRatio: 'P/S',
        pbRatio: 'P/B',
        marketCapHistoryTitle: 'Market cap history',
        marketCapHistorySubtitle: 'Synthetic annual series to visualize regimes and volatility.',
        year: 'Year',
        marketCap: 'Market cap',
        change: 'Change',
      },
      ...
      tabs: {
        ...
        sustainabilityReports: 'Sustainability',
        more: 'More',
      },
      fields: {
        marketCap: 'Market cap',
        ...
        price: 'Price',
        sharePrice: 'Share price',
        change1d: 'Change (1 day)',
        change1y: 'Change (1 year)',
        peRatio: 'P/E',
        psRatio: 'P/S',
        pbRatio: 'P/B',
        operatingMargin: 'Operating margin',
      ...
      sections: {
        marketCap: {
          ...
          subtitle: 'Size signal (model).',
          body: 'Market capitalization is a proxy for company size. This view uses synthetic values for fast comparisons.',
          historyTitle: 'Market cap history',
        },
        revenue: {
          kicker: 'Revenue',
          title: 'Revenue',
          subtitle: 'Synthetic total revenue for quick context.',
        },
        earnings: {
          kicker: 'Earnings',
          title: 'Earnings',
          subtitle: 'Synthetic earnings to compare profitability at a glance.',
        },
        priceHistory: {
          kicker: 'Price',
          title: 'Price history',
          subtitle: 'Last 30 days (synthetic).',
        },
        pe: {
          title: 'P/E ratio',
          subtitle: 'Price-to-earnings ratio (model).',
        },
        ps: {
          title: 'P/S ratio',
          subtitle: 'Price-to-sales ratio (derived).',
        },
        pb: {
          title: 'P/B ratio',
          subtitle: 'Price-to-book ratio (model).',
        },
        operatingMargin: {
          title: 'Operating margin',
          subtitle: 'Operating margin percentage (model).',
        },
        eps: {
          title: 'EPS',
          subtitle: 'Earnings per share (model).',
        },
        splits: {
          title: 'Stock splits',
          subtitle: 'Split events (model).',
          empty: 'No split events in the synthetic dataset.',
        },
        dividends: {
          title: 'Dividends',
          subtitle: 'Recent dividend payments (model).',
        },
        dividendYield: {
          title: 'Dividend yield',
          subtitle: 'Dividend yield percentage (model).',
        },
        shares: {
          title: 'Shares outstanding',
          subtitle: 'Estimated shares outstanding (model).',
        },
        ftd: {
          title: 'Fails to deliver',
          subtitle: 'Synthetic indicator for delivery failures.',
        },
        borrow: {
          title: 'Cost to borrow',
          subtitle: 'Estimated borrow fee (model).',
        },
        assets: {
          title: 'Total assets',
          subtitle: 'Balance sheet snapshot (model).',
        },
        liabilities: {
        ...
        netAssets: {
          title: 'Net assets',
          subtitle: 'Assets minus liabilities (model).',
        },
        annual: {
          title: 'Annual reports',
          subtitle: 'Open official filings (external).',
          openSec: 'Browse on SEC EDGAR',
        },
        annual10k: {
          title: '10-K',
          subtitle: 'Jump directly to 10-K filings (external).',
          openSec: 'Open 10-K on SEC EDGAR',
        },
        annual10q: {
          title: '10-Q',
          subtitle: 'Jump directly to 10-Q filings (external).',
          openSec: 'Open 10-Q on SEC EDGAR',
        },
        annual8k: {
          title: '8-K',
          subtitle: 'Jump directly to 8-K filings (external).',
          openSec: 'Open 8-K on SEC EDGAR',
        },
        cnmv: {
          title: 'CNMV',
          portal: 'Open CNMV portal',
          search: 'Search filings on CNMV',
        },
        fca: {
          title: 'FCA NSM',
          portal: 'Open FCA National Storage Mechanism',
        },
        unternehmensregister: {
          title: 'Unternehmensregister',
          search: 'Search on Unternehmensregister',
        },
        edinet: {
          title: 'EDINET',
          portal: 'Open EDINET portal',
        },
        hkex: {
          title: 'HKEXnews',
          portal: 'Open HKEXnews search',
        },
        filings: {
          title: 'Filings',
          search: 'Search official filings',
        },
        sustainability: {
          title: 'Sustainability reports',
          subtitle: 'Search for ESG / sustainability disclosures (external).',
          search: 'Search sustainability report',
        },
        more: {
          title: 'More',
          subtitle: 'External research shortcuts and utilities.',
        },
      },
      cards: {
        region: {
