  ...
  companies: {
    ...
    detail: {
      ...
      tabGroups: {
        ...
        financials: 'Resultados',
        shareholder: 'Accionariado',
        balance: 'Balance',
        market: 'Mercado',
        reports: 'Informes',
        more: 'Más',
      ...
      overview: {
        faviconAlt: 'Icono de {name}',
        rank: 'Ranking',
        rankHint: 'Posición por cap. bursátil (modelo).',
        marketCap: 'Market cap',
        marketCapHint: 'Estimación sintética para comparación rápida.',
        country: 'País',
        countryHint: 'Inferido por mercado ({market}).',
        sharePrice: 'Precio',
        change1d: '(1 día)',
        change1y: '(1 año)',
        ...
        about: 'Descripción',
        aboutFallback: '{name} es una compañía listada en {market}. Esta ficha resume señales de precio, tamaño y ratios para acelerar el contexto antes de saltar a research externo.',
      },
      facts: {
        kicker: 'Fundamentales',
        title: 'Resumen de {ticker}',
        subtitle: 'Indicadores compactos (modelo) para lectura rápida.',
        tabs: {
          marketCap: 'Market cap',
          revenue: 'Ingresos',
          earnings: 'Beneficios',
        ...
        marketCapSectionTitle: 'Capitalización bursátil de {name} ({ticker})',
        marketCapSectionCopy: 'La capitalización bursátil (market cap) es el valor de mercado de las acciones en circulación. Se usa para comparar tamaño relativo entre compañías.',
        marketCapValueLabel: 'Market cap',
        marketCapValueHint: 'Valor aproximado para este panel (no oficial).',
        revenue: 'Ingresos',
        earnings: 'Beneficios',
        peRatio: 'P/E',
        psRatio: 'P/S',
        pbRatio: 'P/B',
        marketCapHistoryTitle: 'Histórico de market cap',
        marketCapHistorySubtitle: 'Serie anual sintética para ver régimen y volatilidad.',
        year: 'Año',
        marketCap: 'Market cap',
        change: 'Cambio',
      },
      ...
      tabs: {
        ...
        dividendYield: 'Rent. dividendo',
        sharesOutstanding: 'Acciones en circulación',
        failsToDeliver: 'Fails to deliver',
        costToBorrow: 'Coste de préstamo',
        totalAssets: 'Activos totales',
        totalLiabilities: 'Pasivos totales',
        totalDebt: 'Deuda total',
        ...
        annualReports10k: '10-K',
        sustainabilityReports: 'Sostenibilidad',
        more: 'Más',
      },
      fields: {
        marketCap: 'Market cap',
        ...
        price: 'Precio',
        sharePrice: 'Precio',
        change1d: 'Cambio (1 día)',
        change1y: 'Cambio (1 año)',
        peRatio: 'P/E',
        psRatio: 'P/S',
        pbRatio: 'P/B',
        operatingMargin: 'Margen operativo',
      ...
      sections: {
        marketCap: {
          kicker: 'Market cap',
          title: 'Market cap de {ticker}',
          subtitle: 'Señal de tamaño (modelo).',
          body: 'La capitalización bursátil es un proxy del tamaño de una compañía. Esta vista usa valores sintéticos para comparar rápido.',
          historyTitle: 'Histórico de market cap',
        },
        revenue: {
          kicker: 'Ingresos',
          title: 'Ingresos',
          subtitle: 'Ingresos totales sintéticos para contexto rápido.',
        },
        earnings: {
          kicker: 'Beneficios',
          title: 'Beneficios',
          subtitle: 'Beneficios sintéticos para comparar rentabilidad a simple vista.',
        },
        priceHistory: {
          kicker: 'Precio',
          title: 'Histórico de precio',
          subtitle: 'Últimos 30 días (sintético).',
        },
        pe: {
          title: 'Ratio P/E',
          subtitle: 'Precio sobre beneficios (modelo).',
        },
        ps: {
          title: 'Ratio P/S',
          subtitle: 'Precio sobre ventas (derivado).',
        },
        pb: {
          title: 'Ratio P/B',
          subtitle: 'Precio sobre valor en libros (modelo).',
        },
        operatingMargin: {
          title: 'Margen operativo',
          subtitle: 'Porcentaje de margen operativo (modelo).',
        },
        eps: {
          title: 'BPA (EPS)',
          subtitle: 'Beneficio por acción (modelo).',
        },
        splits: {
          title: 'Splits',
          subtitle: 'Eventos de split (modelo).',
          empty: 'No hay eventos de split en el conjunto sintético.',
        },
        dividends: {
          title: 'Dividendos',
          subtitle: 'Pagos recientes de dividendos (modelo).',
        },
        dividendYield: {
          title: 'Rentabilidad por dividendo',
          subtitle: 'Porcentaje de rentabilidad por dividendo (modelo).',
        },
        shares: {
          title: 'Acciones en circulación',
          subtitle: 'Estimación de acciones en circulación (modelo).',
        },
        ftd: {
          title: 'Fails to deliver',
          subtitle: 'Indicador sintético de fallos de entrega.',
        },
        borrow: {
          title: 'Coste de préstamo',
          subtitle: 'Fee estimado de préstamo (modelo).',
        },
        assets: {
          title: 'Activos totales',
          subtitle: 'Snapshot de balance (modelo).',
        },
        liabilities: {
        ...
        netAssets: {
          title: 'Activos netos',
          subtitle: 'Activos menos pasivos (modelo).',
        },
        annual: {
          title: 'Informes anuales',
          subtitle: 'Abrir filings oficiales (externo).',
          openSec: 'Ver en SEC EDGAR',
        },
        annual10k: {
          title: '10-K',
          subtitle: 'Ir directo a filings 10-K (externo).',
          openSec: 'Abrir 10-K en SEC EDGAR',
        },
        annual10q: {
          title: '10-Q',
          subtitle: 'Ir directo a filings 10-Q (externo).',
          openSec: 'Abrir 10-Q en SEC EDGAR',
        },
        annual8k: {
          title: '8-K',
          subtitle: 'Ir directo a filings 8-K (externo).',
          openSec: 'Abrir 8-K en SEC EDGAR',
        },
        cnmv: {
          title: 'CNMV',
          portal: 'Abrir portal CNMV',
          search: 'Buscar filings en CNMV',
        },
        fca: {
          title: 'FCA NSM',
          portal: 'Abrir National Storage Mechanism (FCA)',
        },
        unternehmensregister: {
          title: 'Unternehmensregister',
          search: 'Buscar en Unternehmensregister',
        },
        edinet: {
          title: 'EDINET',
          portal: 'Abrir portal EDINET',
        },
        hkex: {
          title: 'HKEXnews',
          portal: 'Abrir buscador HKEXnews',
        },
        filings: {
          title: 'Filings',
          search: 'Buscar filings oficiales',
        },
        sustainability: {
          title: 'Informes de sostenibilidad',
          subtitle: 'Buscar disclosures ESG / sostenibilidad (externo).',
          search: 'Buscar informe de sostenibilidad',
        },
        more: {
          title: 'Más',
          subtitle: 'Atajos externos y utilidades.',
        },
      },
      cards: {
        region: {
